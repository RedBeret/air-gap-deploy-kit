...
flowchart LR
    subgraph Connected["Internet-connected machine"]
        A[kit bundle] --> B[kit-bundle/\ndocker/ · wheels/ · models/\nmanifest.json]
    end
...
Stack Verification
 ...
 acme-parts-cloud   ✓ OK     GET /health → 200 ok
